...
cat <<-EOH
# this file is generated via https://github.com/docker-pkg/docker-syncthing/blob/$(fileCommit "$self")/$self

Maintainers: Docker Pkg <admwiggin@gmail.com> (@docker-pkg)
GitRepo: https://github.com/docker-pkg/docker-syncthing.git
EOH
